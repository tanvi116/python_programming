...
def build_plot():
    ...
    """
    #calculate in degree distribution (normalized) for DPA graph
    distribution_dict = DPAalgo(27770,12,12)
...
simpleplot.plot_scatter("log/log plot of Normalized in-degree distribution(using simpleplot)", 600, 600,
                        "log(indegree) base e", "log(Normalized Distribution) base e", 
                        [plot1],['plot of DPA graph of n = 27770,m = 12'])